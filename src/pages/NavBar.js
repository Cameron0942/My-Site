...
const NavBar = () => {
  ...
  return (
    <>
      <div
        style={{
          visibility: isLg ? "hidden" : "visible",
          top: 0,
          right: 0,
          position: "fixed",
          zIndex: 999,
        ...
        >
          <div style={{ paddingLeft: 20 }}>
            ...
            <a
              ...
              style={{
                color: "white",
                textDecoration: isHovered.home ? "underline" : "none",
                cursor: isHovered.home ? "pointer" : "",
                fontSize: 24,
              }}
            >{`<CB />`}</a>
          </div>
          ...
          >
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1HVEUHjxJRnF0frB1SLH5OrMIjv6ka-My/edit"
              target="_blank"
              rel="noreferrer"
            >
              Resume
