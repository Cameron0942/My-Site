...
const frontendSkills = [
  {
    react: [reactsvg, "React"],
  },
  {
    HTML5: [html5svg, "HTML5"],
  },
  {
    CSS3: [css3svg, "CSS3"],
  },
  {
    MaterialUI: [muisvg, "Material UI"],
  },
  {
    Bootstrap: [bootstrapsvg, "Bootstrap"],
  },
  {
    jQuery: [jquerysvg, "jQuery"],
  },
  {
    threejs: [threeJSIcon, "Three.js"],
  },
  {
    redux: [reduxsvg, "Redux.js"],
  },
  // {
  //     nextjs: [
  //         nextjsIcon,
...
const backendSkills = [
  ...
  {
    ubuntu: [ubuntusvg, "Ubuntu"],
  },
  {
    nginx: [nginxsvg, "Nginx"],
  },
  {
    mongodb: [mongodbIcon, "MongoDB"],
  },
  {
    mysql: [mysqlsvg, "MySQL"],
  },
];

const tools = [
  {
    vscode: [vscodesvg, "Visual Studio Code"],
  },
  {
    git: [gitsvg, "Git"],
  },
  ...
  {
    npm: [npmsvg, "Node Package Manager"],
  },
  {
    postman: [postmansvg, "Postman"],
  },
  {
    figma: [figmasvg, "Figma"],
  },
];

const languages = [
  {
    javascript: [jsIcon, "JavaScript"],
  },
  {
    python: [pythonIcon, "Python"],
  },
  {
    golang: [golangsvg, "GoLang"],
  },
];

const cloud = [
  {
    digitalocean: [digitaloceanIcon, "Digital Ocean"],
  },
  {
    render: [renderLogo, "Render"],
  },
  {
    aws: [awsIcon, "Amazon Web Services"],
  },
];
      ...
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          <a
            ...
            style={{ color: "#1fb141", textDecoration: "none" }}
          >
            Icons8
          </a>
        </div>
