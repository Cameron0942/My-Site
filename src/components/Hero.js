...
const Hero = () => {
    ...
    return(
        ...
        <ThemeProvider theme={theme}>
                <div style={{display: 'flex', justifyContent: 'space-between', flexDirection: isLg ? 'row' : 'column', alignItems: 'center', paddingTop: 150, paddingLeft: isLg ? '14%' : '5%', marginBottom: 400}}>
