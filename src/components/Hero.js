...
const Hero = () => {
    ...
    return(
        ...
        <ThemeProvider theme={theme}>
                <div id='home' style={{display: 'flex', justifyContent: 'space-between', flexDirection: isLg ? 'row' : 'column', alignItems: 'center', paddingTop: 150, paddingLeft: isLg ? '14%' : '2%', paddingRight: isLg ? '0%' : '2%', marginBottom: 400}}>
                    <div style={{backgroundColor: 'rgba(0, 0, 0, 0.5)', paddingTop: 10, paddingBottom: 10, paddingLeft: 15, paddingRight: 15, borderRadius: '20px'}}>
                        ...
                        <h1 style={{color: 'white', textShadow: '3px 3px black', fontSize: '2.5em', margin: 0}}>I'm Cameron 👨🏼‍💻</h1>
                        ...
                        <p style={{color: "#ededf1", maxWidth: '100ch', fontSize: '1.5em', textShadow: '3px 3px black'}}>
                            I am a fullstack developer committed to creating functional and useful web applications. <b>Check out some of my latest projects!</b>
                        </p>
                        <p style={{color: "#ededf1", maxWidth: '100ch', fontSize: '1.5em', textShadow: '3px 3px black'}}>
