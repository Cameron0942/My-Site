    ...
    <>
      <ThemeProvider theme={theme}>
        <div style={{ maxWidth: "70ch" }}>
          ...
          >
            <b>Coming Soon!</b> A fullstack application that aims to help users keep
            track of bugs and other events in their projects. It will have features
            such as: account creation, bug/task creation, role-based
            authorization, graphical tracking of completed vs in-progress bugs,
            and more!
          </p>
